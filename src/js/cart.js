...
function getCartContents() {
  ...
  for (let i = 0; i < localStorage.length; i++) { 
    let cartItem = getLocalStorage(i+1);
    ...
    // attributes
    listItem.setAttribute('class', 'cart-card divider');
    aItem.setAttribute('class', 'cart-card__image');
    ...
    aItem.appendChild(itemAImg);
    listItem.appendChild(itemA2);
    listItem.appendChild(itemAH2);
    listItem.appendChild(itemPColor);
    listItem.appendChild(itemPQuantity);
    listItem.appendChild(itemPPrice);
